...
CH_OPEN_DEPTH = 0.340    # opening vertices pull IN by this fraction of radius
...
CH_JAG     = 0.022       # dressed stone is nearly true. NOT exactly true: at
CH_ZJAG    = 0.16        # zero this is CAD and a thousand years have not
CH_ANG_JAG = 0.10        # happened to it.
CH_SEED    = 4410207

# ---- THE INTERIOR -- the only new geometry ---------------------------------
# Carved out of the drum above. Nothing here may push the outer surface around.
RM_RIN        = 5.10   # interior radius -> a 10.2 m room. It has to clear the
...
RM_CUT        = 0.60   # HOW FAR BACK the outer face is cut to open the throat,
...
def _chamber(r):
    ...
    return m, _collider(iang, levels[1])


MEASURED = {}          # filled by _chamber: the numbers MDL STATS reports


def _collider(iang, sill_z):
