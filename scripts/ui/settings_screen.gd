...
func _fill_choices() -> void:
	...
	_map_pick_option.add_item(tr("SETTINGS_MAP_PICK_HOST"), int(MatchRules.MapPickMode.HOST))
	_map_pick_option.add_item(tr("SETTINGS_MAP_PICK_VOTE"), int(MatchRules.MapPickMode.VOTE))
