...
## [code]maps/bentham_ring/bentham_ring.tscn[/code] is an ARENA. It is composed into
## [code]match/match.tscn[/code], instanced bare by tests, and loaded by
...
## [code]maps/bentham_ring/bentham_ring.tscn[/code], is widened to include that bit
...
## [code]maps/bentham_ring/bentham_ring.tscn[/code], where they can be seen and moved. The
